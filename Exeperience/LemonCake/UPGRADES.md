...
| 2 | `NewRow_1` | `OutfitUpgrade` | Outfit Upgrade | 25.5 |
| 3 | `NewRow_2` | `DisplayCounter` | Display Counter | 25 |
| 4 | `NewRow_3` | `KitchenWindow` | Kitchen Window | 210.5 |
| 5 | `NewRow_4` | `DisplayCounter` | Display Counter | 55.25 |
| 6 | `NewRow_5` | `CatCafe` | Cat Cafe | 135 |
| 7 | `NewRow_6` | `CoffeeMachine` | Coffee Machine | 275.5 |
| 8 | `NewRow_7` | `DisplayCounter` | Display Counter | 75.25 |
| 9 | `NewRow_8` | `TwoSeats&Table` | Two Seats & Table | 235.5 |
...
| 2 | `NewRow_13` | `Oven` | Oven | 65.75 |
| 3 | `NewRow_14` | `Cow` | Cow | 195.5 |
| 4 | `NewRow_15` | `Chickens` | Chickens | 55.25 |
| 5 | `NewRow_16` | `SpeedBoost` | Speed Boost | 65.25 |
| 6 | `NewRow_17` | `Oven` | Oven | 245.5 |
| 7 | `NewRow_18` | `Freezer` | Freezer | 225.75 |
| 8 | `NewRow_19` | `AnimalBrush` | Animal Brush | 165.5 |
| 9 | `NewRow_20` | `QuickSprint` | Quick Sprint | 230 |
...
| 2 | `NewRow_25` | `StrawberryPlant` | Strawberry Plant | 12.5 |
| 3 | `NewRow_26` | `BlueberryPlant` | Blueberry Plant | 42.5 |
| 4 | `NewRow_27` | `CrystalWater` | Crystal Water | 52.75 |
| 5 | `NewRow_28` | `GrapeVine` | Grape Vine | 90 |
| 6 | `NewRow_33` | `RailCart` | Rail Cart | 120.5 |
| 7 | `NewRow_30` | `CarrotPlant` | Carrot Plant | 180.25 |
| 8 | `NewRow_31` | `Sprinkler` | Sprinkler | 345.5 |
| 9 | `NewRow_32` | `AppleTree` | Apple Tree | 210 |
...
| 2 | `NewRow_37` | `Wardrobe` | Wardrobe | 47.5 |
| 3 | `NewRow_38` | `FairyLights` | Fairy Lights | 82.5 |
| 4 | `NewRow_40` | `Paintings` | Paintings | 120.75 |
| 5 | `NewRow_39` | `Plants` | Plants | 92.25 |
| 6 | `NewRow_41` | `Curtains` | Curtains | 135.5 |
| 7 | `NewRow_42` | `Cat` | Cat | 275.25 |
| 8 | `NewRow_43` | `Dog` | Dog | 355.75 |
| 9 | `NewRow_44` | `WindowNook` | Window Nook | 180.5 |
