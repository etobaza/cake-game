...
- Парсер сохраняет непрочитанные специализированные хвосты как `Extras`: 7 677 exports, 243 925 387 байт. `RawExport=0` не равно полному семантическому декодированию всех ресурсов. В `DAT_Recipe` есть `chocolatePancake`, в `DAT_Item` — `ChocolatePancake`; сохраняйте исходное написание, при сопоставлении учитывайте регистронезависимость UE FName.
